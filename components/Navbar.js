    ...
    return (
        <>
            <div className="nav flex flex-row">
                <div className='sm:ml-10 min-w-20 sm:min-w-1/5'>
                    <Image src={"/aman-logo.png"} className='h-full' width={200} alt='logo' height={200}/>
                </div>
                ...
                <div onClick={handleToggle} className='sm:hidden visible'>
                    <div className='m-0 p-0'>
                        {visible ?
                            ...
                            : <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="35" viewBox="0 0 32 32"
                                style={{ fill: "#FFFFFF" }}>
            ...
            <div>
                <div className=' absolute top-12 m-4 w-full'>
