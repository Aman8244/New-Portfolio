                                ...
                                <div className="mt-12">
                                    ...
                                    <ul className="mt-3">
                                        <li className="flex items-center">
                                            ...
                                            <a href={`mailto:amansinghmarch16@gmail.com`} className="text-[#007bff] text-sm ml-3">
                                                <small className="block">Mail</small>
                                                <strong>amansinghmarch16@gmail.com</strong>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                                <div className="mt-12">
                                    ...
                                    <ul className="flex mt-3 space-x-4">
                                        ...
                                        <li className="bg-[#e6e6e6cf] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                                            <a href="https://www.linkedin.com/in/aman-singh-433240225/">
                                        ...
                                        {/* Github Logo */}
                                        <li className="bg-[#e6e6e6cf] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                                            <a href="https://github.com/Aman8244">
                                        ...
                                        {/* Instagram Logo */}
                                        <li className="bg-[#e6e6e6cf] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                                            <a href="https://www.instagram.com/__a_man_7.0/">
